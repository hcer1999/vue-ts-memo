      ...
      <div class="collapse navbar-collapse navbar-right">
        <ul class="nav navbar-nav">
          ...
          <li class="categories dropdown">
            ...
            <ul class="dropdown-menu">
              <li class="total" @click="filterCateChange(-1)">
                <a>
                  全部
                  <span class="count badge">{{ doFilter(-1) }}</span>
                </a>
              ...
              <li class="divider"></li>
              <li @click="filterCateChange(0)">
                <a>
                  工作
                  <span class="count badge">{{ doFilter(0) }}</span>
                </a>
              </li>
              <li @click="filterCateChange(1)">
                <a>
                  生活
                  <span class="count badge">{{ doFilter(1) }}</span>
                </a>
              </li>
              <li @click="filterCateChange(2)">
                <a>
                  学习
...
export default class MenuBar extends Vue {
  ...
  // 切换显示分类
  filterCateChange(cid: number) {
    this.$store.commit('filterCateIdChange', cid);
  }
}
</script>
<style scoped>
